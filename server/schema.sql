...
INSERT INTO users (name, email, password) VALUES ('Beto', 'user@example.com', 'password1');
INSERT INTO users (name, email, password) VALUES ('dani', 'user2@example.com', 'password2');
